...
---
# Card Dispute Management Policy

### Lost / Stolen cards and dispute resolution procedure
...
- In case of Debit Cards, Cardholder may visit a convenient branch and apply for a replacement card. Cardholder has the option of obtaining an instant debit card, which can be used immediately, or a personalized card, which will be dispatched / delivered within 5 working days to the branch mentioned in the application.
- The Bank may levy a card replacement fee for the replacement of the Credit or Debit Card. (Click for **[Cards & ATM Tariffs >>](https://www.combank.lk/rates-tariff#cards-atm-tariffs)**)
- If the cardholder recovers the lost or stolen card, he/she shall immediately destroy the card (cut it in half) and dispose of it securely.
- If unauthorized transactions have taken place from a lost card or if the card has been stolen, it is prudent for the cardholder to immediately lodge a police complaint.
- The cardholder must take every possible effort to ensure the safety of the card and the PIN to prevent the loss or theft of the card /PIN.
...
- The Bank shall not be responsible for merchandise or services purchased by the cardholder. This may include quality of goods, delay in delivery, non-receipt of goods or services from mail order transactions/internet transactions. The cardholder must resolve any such dispute direct with the merchant / financial institution. In the event that the merchant does not respond favorably, the Bank can assist the cardholder in an attempt to resolve the dispute.
- All Fuel purchases and other services available from fuel/service stations in Sri Lanka are subject to a surcharge by the merchant in order to compensate merchant commission charged by Banks, which shall be debited to the credit, debit or prepaid card account at a rate to be determined by the Bank. This fee is called 'Fuel Surcharge'.
- The 'Fuel Surcharge' is charged from the customer at the time of the settlement when Bank post the transaction to the customer card. Hence customer will see the fuel surcharge added to the fuel transaction in their statements. The SMS sent during the transaction does not contain the fuel surcharge amount and SMS contain the actual transaction amount without fuel surcharge. Please refer the below link to check the prevailing Fuel Surcharge rate. [**https://www.combank.lk/rates-tariff#cards-atm-tariffs**](https://www.combank.lk/rates-tariff#cards-atm-tariffs)
- All cardholder disputes are governed by the Dispute Resolution Regulations as published by the relevant Card Schemes. i.e. Visa International, MasterCard Incorporated and Union Pay International.

### Preventing card fraud

**Important tips to safeguard your card information**

- The cardholder should place the full signature on the reverse of the card as soon as the card is received.
- It is important to inform the Contact Centre immediately on +94 11 2353353 in case of loss/theft of the card or upon observing any unauthorized use of the card. The Contact Centre agent will deactivate the card in order to avoid further transactions being authorized on the card.
- The cardholder should destroy all previous/expired cards by cutting them into two (ideally through the magnetic stripe).
- Always use your credit card account number or NIC number when corresponding with the Bank for card-related matters. Do not mention the complete card number.
- Cardholders are advised to avoid any "scam" e-mails (gifts, lotteries, prizes), posts on social media or any business schemes which requests the card number, expiry date, PIN or the CVV (03 digit code on the reverse of the card) to be submitted in any form. Do not share or disclose One-Time Passwords received with any other party.

**Important tips to avoid ATM and CRM thefts / scams / card skimming**

- The cardholder should be vigilant when performing transactions at unfamiliar ATM/CRMs as there could be skimming/other unusual devices installed. If any unusual devices are observed, please avoid using the ATM/CRM and inform any security personnel or the Contact Centre on +94 11 2353353 immediately.
- It is advised to cover the number pad using your free hand when entering the PIN so that the PIN will not be visible to any other party in the vicinity. Do not share or disclose the PIN with any other party.
- Avoid using an ATM/CRM when other people are around and never rely on the help of strangers to operate the device, specially to deposit/withdraw cash or to retrieve a card which has been captured by the device. Instead, get in touch with the Contact Centre for assistance.
- The cardholder should report a card that has been captured by the device immediately to the Bank. It is advised not to leave the ATM/CRM location, but as a prudent measure call the Contact Centre from the ATM/CRM location where the card was captured.

**Tips on how to use your Credit Card safely for online shopping**
...
- The Bank is not liable to refund any losses incurred due to exchange rate differences on subsequent refunds/reversals made by merchants for transactions performed by the cardholder.
