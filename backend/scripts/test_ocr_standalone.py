...
from app.domain.enums import PredictionTask
...
def run_ocr_test(image_path: str):
    ...
    try:
        ...
        if extracted_text:
            ...
            category, priority, sentiment = classify(
                text=extracted_text,
                is_ocr=True
            )
...
if __name__ == "__main__":
    ...
    run_ocr_test(os.path.join(scripts_dir, "test_ocr.png"))
