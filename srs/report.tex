...
\usepackage[letterpaper,left=1in,right=1in,top=1in,bottom=1in,
            headheight=40pt,headsep=12pt,footskip=30pt]{geometry}
\usepackage{fontspec}
\setmainfont{Tinos}      % Times New Roman-compatible body font
\setsansfont{Arimo}     % Arial-compatible heading font
...
% ---------- Template typography and spacing ----------
\AtBeginDocument{\fontsize{10}{12}\selectfont}
\setlength{\parindent}{0pt}
\setlength{\parskip}{6pt}
\setlist[itemize]{leftmargin=1.5em,itemsep=0pt,topsep=2pt,parsep=0pt}
\setlist[enumerate]{leftmargin=1.7em,itemsep=0pt,topsep=2pt,parsep=0pt}

% Main report headings: Arial-compatible, black, numbered with a 0.5-inch hanging label.
\titleformat{\section}[hang]
  {\sffamily\bfseries\fontsize{12}{14}\selectfont}
  {\makebox[0.5in][l]{\thesection.}}{0pt}{}
\titleformat{\subsection}[hang]
  {\sffamily\bfseries\fontsize{10}{12}\selectfont}
  {\makebox[0.5in][l]{\thesubsection}}{0pt}{}
\titleformat{\subsubsection}[hang]
  {\sffamily\bfseries\fontsize{10}{12}\selectfont}
  {\makebox[0.5in][l]{\thesubsubsection}}{0pt}{}
\titlespacing*{\section}{-0.5in}{6pt}{3pt}
\titlespacing*{\subsection}{-0.5in}{6pt}{3pt}
\titlespacing*{\subsubsection}{-0.5in}{6pt}{3pt}

% ---------- Table of contents styling ----------
\renewcommand{\contentsname}{Table of Contents}
\renewcommand{\cfttoctitlefont}{\hfill\sffamily\bfseries\fontsize{18}{20}\selectfont}
\renewcommand{\cftaftertoctitle}{\hfill\mbox{}\par\vspace{12pt}}
\renewcommand{\cftsecfont}{\rmfamily\mdseries}
\renewcommand{\cftsubsecfont}{\rmfamily\mdseries}
\renewcommand{\cftsecpagefont}{\rmfamily\mdseries}
\renewcommand{\cftsubsecpagefont}{\rmfamily\mdseries}
...
\cftsetindents{section}{0pt}{0.38in}
\cftsetindents{subsection}{0.38in}{0.52in}
\cftsetindents{subsubsection}{0.90in}{0.65in}

% ---------- Header and footer matching the supplied Word template ----------
\newcommand{\templateheader}{%
  \begingroup
  \renewcommand{\arraystretch}{0.88}%
  \setlength{\tabcolsep}{6pt}%
  \begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}X|p{0.26\textwidth}|}
    \hline
    \projectname & Version:\hfill \documentversion \\
    \hline
    \documenttype & Date:\hfill \documentdate \\
    \hline
...
\fancypagestyle{template}{%
  ...
  \fancyfoot[L]{\rmfamily\fontsize{10}{12}\selectfont Confidential}
  \fancyfoot[C]{\rmfamily\fontsize{10}{12}\selectfont \copyright\ \companyname, 2026}
  \fancyfoot[R]{\rmfamily\fontsize{10}{12}\selectfont Page \thepage\ of \pageref{LastPage}}
...
\newenvironment{requirements}{%
  ...
  \begin{longtable}{|>{\raggedright\arraybackslash}p{0.19\linewidth}|>{\raggedright\arraybackslash}p{0.75\linewidth}|}
  \hline\textbf{ID} & \textbf{Requirement}\\\hline\endhead}{\hline\end{longtable}}

% The Word template indents body material by 0.5 inch while section numbers remain at the margin.
\newenvironment{templatebody}{%
  \par
  \setlength{\leftskip}{0.5in}%
  \setlength{\rightskip}{0pt}%
  \setlength{\linewidth}{\dimexpr\textwidth-0.5in\relax}%
...
\begin{titlepage}
  ...
  \begin{flushright}
    {\sffamily\bfseries\fontsize{18}{20}\selectfont \companyname\par}
  \end{flushright}
  ...
  \begin{flushright}
    {\sffamily\bfseries\fontsize{18}{20}\selectfont \projectname\par}
    \vspace{0.04in}
    {\sffamily\bfseries\fontsize{18}{20}\selectfont \documenttype\par}
    \vspace{0.30in}
    {\sffamily\bfseries\fontsize{14}{16}\selectfont Version \documentversion\par}
  \end{flushright}
\end{titlepage}
\setcounter{page}{2}
...
\begin{tabularx}{\dimexpr\textwidth-2pt\relax}{|p{0.20\textwidth}|p{0.12\textwidth}|X|p{0.20\textwidth}|}
\hline
\centering\sffamily\bfseries Date &
\centering\sffamily\bfseries Version &
\centering\arraybackslash\sffamily\bfseries Description &
\centering\arraybackslash\sffamily\bfseries Author\\
\hline
30/Jul/26 & 1.0 & Initial version aligned with the supplied document template. & Group 21\\
\hline
~ & ~ & ~ & ~\\
\hline
\end{tabularx}
