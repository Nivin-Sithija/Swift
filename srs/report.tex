...
\vspace{8pt}
{\sffamily\bfseries\fontsize{19}{23}\selectfont\documenttype\par}
\vspace{22pt}
{\sffamily\bfseries\fontsize{14}{17}\selectfont Version \documentversion}
\end{flushright}
\vfill
...
30/Jul/26 & 1.0 & Initial version of SRS document. & S.Ruththiragayan\\\hline
~ & ~ & ~ & ~\\\hline
\end{tabularx}
\end{table}
